        ...
        <div className="background-photo">
          <Grid container stackable centered columns="3">
            <Grid.Column textAlign='center'>
              <Icon className="header-icons" name="users" size="huge"/>
              ...
              <Header as='h3' inverted>
                ...
                You can only see the contact you have already created.
              </Header>
            </Grid.Column>
            <Grid.Column textAlign='center'>
              <Icon className="header-icons" name="file alternate" size="huge"/>
            ...
            <Grid.Column textAlign='center'>
              <Icon className="header-icons" name="calendar check outline" size="huge"/>
              <Header as='h1' inverted>Timestamped Notes</Header>
              <Header as='h3' inverted>
                Each time you make contact with a contact, you can write note that summarizes
