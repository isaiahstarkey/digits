        ...
        <div className='header-background'>
          <Grid container centered stackable columns='3'>
            <Grid.Column textAlign='center'>
              <Icon className='icons' name='users' size='huge'/>
              <Header as='h1' inverted> Multiple Users</Header>
              <Header as='h3' inverted>
                This address book enables any number of users to register and
                save their business contacts. You can only see the contacts you have created.
              </Header>
            </Grid.Column>
            <Grid.Column textAlign='center'>
              <Icon className='icons' name='file alternate' size='huge'/>
            ...
            <Grid.Column textAlign='center'>
              <Icon className='icons' name='calendar check outline' size='huge'/>
